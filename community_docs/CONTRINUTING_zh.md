...
欢迎参与openJiuwen文档贡献。您可以对现有文档进行评价、更改、反馈问题或贡献原创内容，我们鼓励开发者以各种方式参与文档反馈和贡献。

## 内容版权

用户提交的内容、图片必须是原创内容，不得侵犯他人知识产权。

openJiuwen有权根据相关规范修改开发者贡献的内容。
...
2. 单击“新建 Issue”按钮，完成 Issue 提交。请耐心等待openJiuwen文档团队确认您的问题。

> **如何反馈一个高质量的问题？**
>
> - 提供文档的具体位置、名称以及问题的清晰描述，给出具体缺失或错误的内容或者需要改进的文字，必要时提供截图。
> - 解释该问题对用户的影响。
> - 如果是文档示例错误，请提供具体执行的openJiuwen版本、环境、及报错信息。
...
openJiuwen文档团队成员将评审并合并您的修改内容，感谢您对openJiuwen文档的支持和帮助。
...
3. 本地完成文档更改后提交 PR。
4. 等待门禁验证和openJiuwen文档团队成员审核，通过后合入。
