...
首先使用openJiuwen提供的`create_react_agent`方法快速创建`ReActAgent`。该Agent提供特定日期的天气查询的功能。示例代码如下：
...
```python
from jiuwen.core.utils.llm.messages import HumanMessage, AIMessage, SystemMessage
