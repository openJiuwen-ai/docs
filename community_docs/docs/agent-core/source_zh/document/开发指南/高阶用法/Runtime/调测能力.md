...
调测字段参考API接口文档[jiuwen.core.stream.base.TraceSchema]()。
...
from jiuwen.core.runtime.base import ComponentExecutable, Output, Input
...
type='tracer_workflow' payload={'traceId': '9d494056-0a13-43a6-beaf-54af5448f1d0', 'startTime': datetime.datetime(2025, 10, 25, 16, 23, 55, 920343), 'endTime': datetime.datetime(2025, 10, 25, 16, 23, 55, 920582), 'inputs': {'result': 3}, 'outputs': {'responseContent': '', 'output': {'result': 3}}, 'error': None, 'invokeId': 'end', 'parentInvokeId': 'add', 'executionId': '9d494056-0a13-43a6-beaf-54af5448f1d0', 'onInvokeData': [], 'componentId': '', 'componentName': '', 'componentType': 'end', 'loopNodeId': None, 'loopIndex': None, 'status': 'finish', 'parentNodeId': ''}
type='workflow_final' index=0 payload={'responseContent': '', 'output': {'result': 3}}
...
输出结果如下，其中最后一帧为自定义的错误调测信息。

```python
type='tracer_workflow' payload={'traceId': '397ba3a2-267b-4369-b35c-0545734428c2', 'startTime': datetime.datetime(2025, 10, 25, 16, 23, 55, 989038), 'endTime': None, 'inputs': None, 'outputs': None, 'error': None, 'invokeId': 'start', 'parentInvokeId': None, 'executionId': '397ba3a2-267b-4369-b35c-0545734428c2', 'onInvokeData': [], 'componentId': '', 'componentName': '', 'componentType': 'start', 'loopNodeId': None, 'loopIndex': None, 'status': 'start', 'parentNodeId': ''}
type='tracer_workflow' payload={'traceId': '397ba3a2-267b-4369-b35c-0545734428c2', 'startTime': datetime.datetime(2025, 10, 25, 16, 23, 55, 989038), 'endTime': datetime.datetime(2025, 10, 25, 16, 23, 55, 989250), 'inputs': None, 'outputs': None, 'error': None, 'invokeId': 'start', 'parentInvokeId': None, 'executionId': '397ba3a2-267b-4369-b35c-0545734428c2', 'onInvokeData': [], 'componentId': '', 'componentName': '', 'componentType': 'start', 'loopNodeId': None, 'loopIndex': None, 'status': 'finish', 'parentNodeId': ''}
type='tracer_workflow' payload={'traceId': '397ba3a2-267b-4369-b35c-0545734428c2', 'startTime': datetime.datetime(2025, 10, 25, 16, 23, 56, 15528), 'endTime': None, 'inputs': {'a': None, 'b': 2}, 'outputs': None, 'error': None, 'invokeId': 'add', 'parentInvokeId': 'start', 'executionId': '397ba3a2-267b-4369-b35c-0545734428c2', 'onInvokeData': [], 'componentId': '', 'componentName': '', 'componentType': 'add', 'loopNodeId': None, 'loopIndex': None, 'status': 'start', 'parentNodeId': ''}
type='tracer_workflow' payload={'traceId': '397ba3a2-267b-4369-b35c-0545734428c2', 'startTime': datetime.datetime(2025, 10, 25, 16, 23, 56, 15528), 'endTime': datetime.datetime(2025, 10, 25, 16, 23, 56, 15748), 'inputs': {'a': None, 'b': 2}, 'outputs': None, 'error': {'error_code': -1, 'message': 'a is not exit'}, 'invokeId': 'add', 'parentInvokeId': 'start', 'executionId': '397ba3a2-267b-4369-b35c-0545734428c2', 'onInvokeData': [], 'componentId': '', 'componentName': '', 'componentType': 'add', 'loopNodeId': None, 'loopIndex': None, 'status': 'error', 'parentNodeId': ''}
