...
* 运行以下命令安装 Node.js 和 npm：
  ...
  ```
  > **注意**：部分 linux 系统软件源 nodejs 与 npm 版本较老，请参考 <a href="https://nodejs.org/zh-cn/download" target="_blank" rel="nofollow noopener noreferrer"> nodejs 官网</a> 安装新版本（20.0及以上）。
...
### <a id="linux-memory"></a> 问题一：如何启用记忆功能
...
### <a id="linux-sandbox"></a> 问题二：如何启用沙箱功能
