...
2. Configure components: configure the components added to the workflow and link them in business order.
3. Debug and run the workflow.
4. After successful debugging, you can publish the workflow or export it.