...
* ​**config**([ToolComponentConfig](#class-openjiuwencorecomponenttool_comptoolcomponentconfig), 可选)​：插件组件的配置信息。
...
>>> result = await workflow.invoke({"location": "hangzhou", "date": "2025-08-01", "conversation_id": "c123"}, WorkflowRuntime())
