...
>>> print(res)
type='function' function=Function(name='add', description='function add', parameters=Parameters(type='object', properties={'a': {'description': 'first arg', 'type': 'integer'}, 'required': ['a', 'b'], 'b': {'description': 'second arg', 'type': 'integer'}}, required=['a', 'b']))
```
