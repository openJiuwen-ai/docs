...
| [TemplateManager](./utils/prompt/template.md#class-openjiuwencoreutilsprompttemplatetemplate_managertemplatemanager)     | 全局提示词模板管理单例。 |
...
| CLASS                                            | DESCRIPTION                  |
|--------------------------------------------------|------------------------------|
| [BaseOutputParser](./utils/output_parser.md#class-openjiuwencoreutilsoutput_parserbasebaseoutputparser)     | 定义了输出解析器的基类。                 |
| [JsonOutputParser](./utils/output_parser.md#class-openjiuwencoreutilsoutput_parserbasejsonoutputparser)     | 解析任意字符和大模型输出结果中包含的Json数据。    |
| [MarkdownOutputParser](./utils/output_parser.md#class-openjiuwencoreutilsoutput_parsermarkdown_output_parsermarkdownoutputparser) | 解析任意字符和大模型输出结果包含的Markdown信息。 |
