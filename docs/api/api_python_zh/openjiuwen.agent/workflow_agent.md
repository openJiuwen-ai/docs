...
- 样例一：
  ...
  WorkflowAgent输出的最终结果：{'output': WorkflowOutput(result={'responseContent': "{'city': 'Shanghai', 'country': 'CN', 'feels_like': 28.89, 'humidity': 59, 'temperature': 27.68, 'weather': '晴', 'wind_speed': 4.13}", 'output': {}}, state=<WorkflowExecutionState.COMPLETED: 'COMPLETED'>), 'result_type': 'answer'}
  >>> 
...
- 样例二：
  ...
  WorkflowAgent中断恢复后输出结果 >>> {'output': WorkflowOutput(result={'responseContent': '上海', 'output': {}}, state=<WorkflowExecutionState.COMPLETED: 'COMPLETED'>), 'result_type': 'answer'}
  >>> 
  >>> if __name__ == "__main__":
  ...     asyncio.run(run_test())
  ```
...
- 样例一：
  ...
  ...         print(f"流式输出: {chunk}")
  流式输出: type='tracer_workflow' payload={'traceId': '05354dbc-dab6-49aa-b7ca-b255180b6559', 'startTime': datetime.datetime(2025, 10, 10, 16, 46, 2, 444639), 'endTime': datetime.datetime(2025, 10, 10, 16, 46, 2, 445668), 'inputs': {'output': {'city': 'Shanghai', 'country': 'CN', 'feels_like': 28.82, 'humidity': 59, 'temperature': 27.63, 'weather': '晴', 'wind_speed': 4.13}}, 'outputs': {'responseContent': "{'city': 'Shanghai', 'country': 'CN', 'feels_like': 28.82, 'humidity': 59, 'temperature': 27.63, 'weather': '晴', 'wind_speed': 4.13}", 'output': {}}, 'error': None, 'invokeId': 'end', 'parentInvokeId': 'plugin', 'executionId': '05354dbc-dab6-49aa-b7ca-b255180b6559', 'conversationId': '', 'onInvokeData': [], 'agentId': '', 'componentId': '', 'componentName': '', 'componentType': 'end', 'agentParentInvokeId': '', 'metaData': '{"component_id": "", "component_name": "", "component_type": "end"}', 'loopNodeId': None, 'loopIndex': None, 'status': 'finish', 'parentNodeId': ''}
  >>> 
  >>> if __name__ == "__main__":
  ...     asyncio.run(run_test())
  ```
- 样例二：
  ...
  WorkflowAgent中断恢复后输出结果 >>> type='tracer_workflow' payload={'traceId': 'b828c79d-d546-44cf-a7e2-3d3488f9713e', 'startTime': datetime.datetime(2025, 10, 10, 16, 51, 46, 545213), 'endTime': datetime.datetime(2025, 10, 10, 16, 51, 46, 545587), 'inputs': {'output': '上海'}, 'outputs': {'responseContent': '上海', 'output': {}}, 'error': None, 'invokeId': 'end', 'parentInvokeId': 'questioner', 'executionId': 'b828c79d-d546-44cf-a7e2-3d3488f9713e', 'conversationId': '', 'onInvokeData': [], 'agentId': '', 'componentId': '', 'componentName': '', 'componentType': 'end', 'agentParentInvokeId': '', 'metaData': '{"component_id": "", "component_name": "", "component_type": "end"}', 'loopNodeId': None, 'loopIndex': None, 'status': 'finish', 'parentNodeId': ''}
  >>> 
  >>> if __name__ == "__main__":
  ...     asyncio.run(run_test())
  ```
...
- **workflows**(List[[Workflow](../openjiuwen.core/workflow/workflow_config.md#openjiuwencoreworkflowworkflow_config)])])：需要绑定到WorkflowAgent的工作流列表。
